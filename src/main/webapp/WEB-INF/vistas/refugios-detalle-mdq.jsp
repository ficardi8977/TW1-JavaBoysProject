  ...
  <div class="Content" style="width: 100%">
    <c:if test="${not empty refugio}">
      ...
      <div class="card" style="width: 100%">
        <div class="h-100 card-encabezado">
            ...
            <div class="copy-link m-2">
              <ul style="list-style:none;border-radius: 10px;overflow: hidden" class="p-0">
                ...
                <li class="lista-compartir">
                  ...
                  <a class="enlace-compartir-tw m-0" href='https://twitter.com/intent/tweet?text=¡Echa un vistazo al refugio "${refugio.nombre}"!: ' data-action="share/tweet" target="_blank">
                    <span class="copiar-enlace">Twitter</span>
                  </a>
                </li>
                <li class="lista-compartir">
                  <i class="fa fa-whatsapp" style="font-size:20px;text-align: center;color:black;"></i>
                  <a class="enlace-compartir-wpp m-0" href='https://web.whatsapp.com/send?text=¡Echa un vistazo al refugio "${refugio.nombre}"!: ' target="_blank">
                    <span class="copiar-enlace">WhatsApp</span>
                  </a>
                </li>
              </ul>
            </div>
            <div class="card-body btn-share">
